...
const internalLinks = [
  ...
  { label: 'Mandiles con Logo', href: '/shop/aprons' },
  { label: 'Uniformes para Restaurantes', href: '/restaurants' },
  { label: 'Ver Catalogo Completo', href: '/shop' },
  { label: 'Disenar Mi Uniforme', href: '/customize' },
  ...
  return (
    <SeoLandingLayout>
      <SeoHero
        ...
        primaryCta={{ label: 'Disenar Mi Uniforme', href: '/customize' }}
      ...
      <SeoCTA
        ...
        primaryCta={{ label: 'Comenzar Ahora', href: '/customize' }}
        secondaryCta={{ label: 'Contactar Ventas', href: '/contact' }}
      />
    </SeoLandingLayout>
  )
}
