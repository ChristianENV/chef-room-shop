...
const internalLinks = [
  { label: 'Ver Todos los Mandiles', href: '/shop?categoria=mandiles' },
  { label: 'Mandil Profesional Chef', href: '/products/mandil-profesional-chef' },
  { label: 'Mandil Bistro Premium', href: '/products/mandil-bistro-premium' },
  { label: 'Filipinas Personalizadas', href: '/shop/chef-jackets' },
  { label: 'Uniformes para Restaurantes', href: '/restaurants' },
  ...
  return (
    <SeoLandingLayout>
      <SeoHero
        ...
        primaryCta={{ label: 'Disenar Mandil', href: '/customize?tipo=mandiles' }}
        secondaryCta={{ label: 'Ver Estilos', href: '/shop?categoria=mandiles' }}
      />
      ...
      <SeoCTA
        ...
        primaryCta={{ label: 'Comenzar Diseno', href: '/customize?tipo=mandiles' }}
        secondaryCta={{ label: 'Cotizar Mayoreo', href: '/mayoreo' }}
      />
    </SeoLandingLayout>
  )
}
