            ...
            <div className="space-y-3">
              <TypographyExample label="Body" font="body" size="16px" weight="Regular">
                <p className="font-serif text-base text-foreground leading-relaxed">
                  Creamos uniformes de chef de la más alta calidad, combinando materiales premium
                  con tecnología de confección avanzada. Cada pieza está diseñada para ofrecer
                  comodidad y durabilidad en el ambiente más exigente.
                </p>
              </TypographyExample>

              <TypographyExample label="Small" font="body" size="14px" weight="Regular">
                <p className="font-serif text-sm text-muted-foreground">
                  Incluye personalización de nombre o logo. Envío gratis en pedidos mayores a $1999
                  MXN.
                </p>
              </TypographyExample>
