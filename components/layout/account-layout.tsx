...
import { accountNav } from '@/src/config/navigation'
...
export function AccountLayout({
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      <PublicHeader cartItemCount={cartItemCount} isLoggedIn={true} userName={userName} />
      ...
      <PublicFooter showNewsletter={false} />
    </div>
  )
}
