            ...
            <header className="border-b border-border bg-card px-4 py-4 md:px-6">
              <div className="mx-auto flex max-w-6xl items-center justify-between">
                ...
                <nav className="hidden items-center gap-6 md:flex">
                  <a href="#" className="font-sans text-sm font-medium text-foreground hover:text-accent">
                    Filipinas
                  </a>
                  <a href="#" className="font-sans text-sm font-medium text-muted-foreground hover:text-accent">
                    Mandiles
                  </a>
                  <a href="#" className="font-sans text-sm font-medium text-muted-foreground hover:text-accent">
                    Pantalones
