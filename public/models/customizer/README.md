...
In development only, you may place files under `chef-jacket/` for offline work. They are gitignored and are **not** used when the product has an active R2 model.
