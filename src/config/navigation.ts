...
/** Shop sub-links shared by header dropdown, mobile menu, and footer */
...
/** Primary public header navigation */
...
export const accountNav = {
  ...
  orders: { label: 'Mis Pedidos', href: routes.accountOrders },
  designs: { label: 'Diseños Guardados', href: routes.accountDesigns },
  addresses: { label: 'Direcciones', href: routes.accountAddresses },
} as const
