...
export const accountResolvers = {
  Query: {
    meProfile: (_parent: unknown, _args: unknown, context: GraphQLContext) =>
      getMeProfile(context),
