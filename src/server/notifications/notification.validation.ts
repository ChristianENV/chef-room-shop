...
export const createAdminNotificationInputSchema = createNotificationInputSchema.omit({
  audience: true,
})
...
export const notificationAudienceFilterSchema = z.nativeEnum(NotificationAudience).optional()
