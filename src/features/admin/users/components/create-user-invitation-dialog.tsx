...
type CreateUserInvitationFormProps = {
  defaultTargetRole: InvitableTargetRole
  lockTargetRole: boolean
  onClose: () => void
  onCreated?: () => void
...
function CreateUserInvitationForm({
  defaultTargetRole,
  lockTargetRole,
  onClose,
  onCreated,
}: CreateUserInvitationFormProps) {
      ...
      <div className="space-y-2">
        ...
        {lockTargetRole ? (
          ...
          <Select
            ...
            disabled={isPending}
          >
            <SelectTrigger id="invite-role" className="font-sans" data-testid="invite-role-select">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
