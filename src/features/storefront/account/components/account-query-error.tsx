  ...
  return (
    <Card className="border-border bg-card">
      <CardContent className="flex flex-col items-center justify-center py-12 text-center">
        ...
        <h3 className="font-sans text-lg font-semibold text-foreground">Algo salió mal</h3>
        <p className="mt-2 max-w-sm font-serif text-sm text-muted-foreground">{message}</p>
        {onRetry ? (
