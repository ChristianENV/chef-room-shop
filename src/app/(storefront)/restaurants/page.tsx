...
const internalLinks = [
  ...
  { label: 'Catálogo Completo', href: routes.shop },
  { label: 'Contactar Ventas Mayoreo', href: routes.contact },
  { label: 'Solicitar Cotizacion', href: routes.contact },
]
  ...
  return (
    <SeoLandingLayout>
      <SeoHero
        ...
        primaryCta={{ label: 'Solicitar Cotizacion', href: routes.contact }}
      ...
      <SeoCTA
        ...
        primaryCta={{ label: 'Solicitar Cotizacion', href: routes.contact }}
        secondaryCta={{ label: 'Hablar con Asesor', href: routes.contact }}
      />
    </SeoLandingLayout>
  )
}
