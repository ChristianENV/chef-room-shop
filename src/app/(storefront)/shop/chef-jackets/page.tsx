...
const internalLinks = [
  { label: 'Ver Todas las Filipinas', href: shopCategoryUrl('filipinas') },
  { label: 'Filipina Executive Blanca', href: routes.productDetail('filipina-executive-blanca') },
  { label: 'Filipina Slim Fit Negra', href: routes.productDetail('filipina-slim-fit-negra') },
  { label: 'Uniformes para Chef', href: routes.shop },
  { label: 'Mandiles Personalizados', href: routes.aprons },
  { label: 'Guía de Bordados', href: routes.sizeGuide },
]
